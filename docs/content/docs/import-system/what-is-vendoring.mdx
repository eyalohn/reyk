...
(either dynamically via `sys.meta_path` (See more in [Meta Path](./meta-path.mdx)) or literally modifying the code).
...
This option is used by [`pip`](https://github.com/pypa/pip/tree/main/src/pip/_vendor).
...
You can read more about the [builtins import](./builtins-import.mdx) here.
